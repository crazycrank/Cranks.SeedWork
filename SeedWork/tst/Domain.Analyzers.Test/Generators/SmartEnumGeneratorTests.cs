...
[SmartEnum]
public sealed partial record TestSmartEnum(int Key, string Value) : SmartEnum<int>(Key)
{
...
partial record TestSmartEnum
{
    ...
    {
        return TestSmartEnum.TryGet(key, out var @enum) ? @enum : throw new System.InvalidCastException($""Cannot cast '{key}' to TestSmartEnum"");
    }
